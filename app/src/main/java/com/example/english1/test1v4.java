...
public class test1v4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_test1v4);

        if(activity == 0){
            activity = activity + 1;
        }

        @SuppressLint("WrongViewCast") Button b1 = findViewById(R.id.yes1v4);
        @SuppressLint("WrongViewCast") Button b2 = findViewById(R.id.no1v4);
